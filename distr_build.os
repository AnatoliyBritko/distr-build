...
Процедура ВыполнитьКопированиеФайлов()
	...
	ИмяКаталога = СтруктураНастроек.КаталогРелизов + "\Обновление " + мДатаРелизаПропись + " " + СтруктураНастроек.ПрефиксСоздаваемогоРелиза + " релиз " + СтруктураНастроек.НомерСоздаваемогоРелиза; 
