...
Процедура ЗадатьНачальныеНастройки()
	...
	СтруктураНастроек.КаталогСборки = СтруктураНастроек.КаталогСборки + СокрЛП(ГУИД) + "\";
		...
		//мКаталогСборки = "c:\Les82\";
	КаталогЛогов   = ПутьКВременномуКаталогу() +"DumpResults\";
	
	//НомерСоздаваемогоРелиза = "2.7.33.2";
	

/////Парам = "File=""h:\Les\Базы\8.2\_Лесхоз Островец"";Usr=""Администратор"";Pwd="""";";
...
Функция ПолучитьМассивСfдляРелиза()
	...
	//МассивДистрибутивов = Новый Массив;
	//МассивДистрибутивов.Добавить("c:\Les82\2.7.18.0.cf");
...
Процедура СоздатьФайлПоставки()
	...
	Путь = ПутьКВременнойБазе();//"\\Fs\srv-backup\Базы лесников\Лесное хозяйство 8.2\-=Базы=-\_Нарочанский парк";
...
Процедура ВыполнитьРаботыНаХранилище()
	...
	//СтрокаСоединения 	= "\\fs\SRV-BACKUP\Базы лесников\-=Хранилище=-\-=ХР=-\";
	//СтрокаСоединения 	= "\\fs\SRV-BACKUP\Базы лесников\-=Хранилище=-\-=БТ=-\";
	//СтрокаСоединения 	= "\\fs\SRV-BACKUP\Базы лесников\-=Хранилище=-\-=НП=-\";
	
	//КаталогРелизов		= "\\fs\SRV-BACKUP\Базы лесников\Лесное хозяйство 8.2\-= Релизы =-\Хозрасчет\";
	//КаталогРелизов 		= "\\fs\SRV-BACKUP\Базы лесников\Лесное хозяйство 8.2\-= Релизы =-\Бюджет\";
	//КаталогРелизов		= "\\fs\SRV-BACKUP\Базы лесников\Лесное хозяйство 8.2\-= Релизы =-\НацПарки\";
